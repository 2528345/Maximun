...
file_must_exist "ops/microos_bootstrap.sh"
file_must_exist "ops/install_from_usb.sh"
file_must_exist "ops/deploy_microos.sh"
...
file_must_exist "ops/autocheck_modules.sh"
file_must_exist "ops/install_autocheck_service.sh"
